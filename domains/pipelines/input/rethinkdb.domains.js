...
let debug = require('debug')('mngr-ui-admin:apps:domains:Pipeline:Domains:Input'),
    debug_internals = require('debug')('mngr-ui-admin:apps:domains:Pipeline:Domains:Input:Internals');
...
module.exports = new Class({
  ...
  initialize: function(options){
    ...
    // this.register_on_changes.bind(this)
		...
		this.profile('mngr-ui-admin:apps:domains:Pipeline:Domains:Input_init');//start profiling


		this.profile('mngr-ui-admin:apps:domains:Pipeline:Domains:Input_init');//end profiling

		this.log('mngr-ui-admin:apps:domains:Pipeline:Domains:Input', 'info', 'mngr-ui-admin:apps:domains:Pipeline:Domains:Input started');
  },
